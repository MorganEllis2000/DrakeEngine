...
Matrix4x4::Matrix4x4(const Matrix3x3& a_other, const Vector3D& a_vector) {
	m_matrixValues[0]  = a_other[0]; m_matrixValues[1]  = a_other[1]; m_matrixValues[2]  = a_other[2]; m_matrixValues[3]  = a_vector.x;
	m_matrixValues[4]  = a_other[3]; m_matrixValues[5]  = a_other[4]; m_matrixValues[6]  = a_other[5]; m_matrixValues[7]  = a_vector.y;
	m_matrixValues[8]  = a_other[6]; m_matrixValues[9]  = a_other[7]; m_matrixValues[10] = a_other[8]; m_matrixValues[11] = a_vector.z;
